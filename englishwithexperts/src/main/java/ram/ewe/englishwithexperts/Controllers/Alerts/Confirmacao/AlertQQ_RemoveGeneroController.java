...
public class AlertQQ_RemoveGeneroController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if(LanguagesRepository.getPort())
        {
            ...
            info4.setText("ID "+tools.genero_id.getText()+" - "+tools.genero_genero_txt.getText());
