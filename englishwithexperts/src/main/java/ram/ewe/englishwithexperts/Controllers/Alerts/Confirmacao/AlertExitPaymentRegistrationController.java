...
public class AlertExitPaymentRegistrationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        if(LanguagesRepository.getPort())
        {
            ...
            info1.setText("Tem certeza de que deseja cancelar");
            info2.setText("o pagamento?");
        ...
        else
        {
            ...
            info1.setText("Are you sure you want to cancel");
            info2.setText("the payment?");
    ...
    {
        try {
            RegistrationsController registrationsController = getLoader().getController();
            registrationsController.hidePayment();
            Model.getInstance().getAlertsFactory().getOnExitPaymentSuccess();
        } catch (Exception e) {
