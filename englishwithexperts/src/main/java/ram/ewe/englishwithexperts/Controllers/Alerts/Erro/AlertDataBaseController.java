...
public class AlertDataBaseController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        if(LanguagesRepository.getPort())
        {
            ...
            info1.setText("Conexão perdida. Tente reconectar");
            info2.setText("ou entre em contacto com o");
            info3.setText("Administrador do Sistema.");
        }
        else
        {
            title.setText("Error Message");
            info1.setText("Connection lost. Try reconnecting");
            info2.setText("or contact your System");
            info3.setText("Administrator.");
        }
