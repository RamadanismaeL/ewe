...
public class AlertPasswordEqualController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        if(LanguagesRepository.getPort())
        {
            ...
            info1.setText("As senhas não são iguais. Verifique");
            info2.setText("e corrija.");
        }
        else
        {
            title.setText("Error Message");
            info1.setText("The passwords do not match. Please");
            info2.setText("check and correct.");
        }
