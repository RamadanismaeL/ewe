...
public class AlertPassword6Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        if(LanguagesRepository.getPort())
        {
            ...
            info1.setText("A senha deve ter no mínimo 6");
            info2.setText("caracteres.");
        }
        else
        {
            title.setText("Error Message");
            info1.setText("The password must be at least 6");
            info2.setText("characters long.");
        }
