...
public class AlertExitAppController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        if(LanguagesRepository.getPort())
        {
            ...
            info1.setText("Você será desconectado. Tem certeza");
            info2.setText("de que deseja encerrar o sistema?");
        ...
        else
        {
            ...
            info1.setText("You will be disconnected.");
            info2.setText("Are you sure you want to log out?");
    ...
    public void btnExitSim()
    {
        try {
            ...
            Model.getInstance().getProgressFactory().getOnProgressExitApp();
        } catch (IOException e) {
