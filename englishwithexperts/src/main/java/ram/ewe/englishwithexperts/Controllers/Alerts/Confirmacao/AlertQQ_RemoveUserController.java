...
public class AlertQQ_RemoveUserController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if(LanguagesRepository.getPort())
        {
            ...
            info1.setText("Tem alterações não salvas.");
            info2.setText("Ainda deseja excluir?");
            info4.setText("ID "+usersController.ID.getText()+" - "+usersController.txtNomeCompleto.getText());
        ...
        else
        {
            ...
            info1.setText("You have unsaved changes.");
            info2.setText("Do you still want to delete?");
            info4.setText("ID "+usersController.ID.getText()+" - "+usersController.txtNomeCompleto.getText());
    ...
    public void btnExitSim()
    {
        ...
        //ModelDataDAO.getInstance().getUserDataModel().setUserLogs(ModelDataDAO.getInstance().getUserDataModel().getUserName(), ModelDataDAO.getInstance().getUserDataModel().getProfile(), "O sistema foi encerrado.");
        UsersController usersController = getLoader().getController();
