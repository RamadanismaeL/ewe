...
public class AlertQ_RemoveNDMController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if(LanguagesRepository.getPort())
        {
            ...
            info1.setText("ID "+tools.getId_ndm()+" - "+tools.ndm_nivel_txt.getText()+" - "+tools.ndm_duracao_txt.getText());
