...
public class AlertTableUpdateController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        if(LanguagesRepository.getPort())
        {
            ...
            info1.setText("Dados atualizados com sucesso.");
            info2.setText("A tabela foi recarregada.");
        }
        else
        {
            title.setText("Success Message");
            info1.setText("Data updated successfully.");
            info2.setText("The table has been reloaded.");
        }
