...
public class AlertUserExistController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        if(LanguagesRepository.getPort())
        {
            ...
            info1.setText("Este usuário já está registrado.");
            info2.setText("Tente um diferente.");
        }
        else
        {
            title.setText("Error Message");
            info1.setText("This username is already registered.");
            info2.setText("Please try a different one.");
        }
