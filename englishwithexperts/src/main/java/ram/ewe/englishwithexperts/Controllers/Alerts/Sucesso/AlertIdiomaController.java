...
public class AlertIdiomaController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        if(LanguagesRepository.getPort())
        {
            ...
            info1.setText("Idioma alterado com sucesso.");
            info2.setText("Por favor, reinicie o aplicativo.");
        }
        else
        {
            title.setText("Success Message");
            info1.setText("Language changed successfully.");
            info2.setText("Please restart the app to apply.");
        }
