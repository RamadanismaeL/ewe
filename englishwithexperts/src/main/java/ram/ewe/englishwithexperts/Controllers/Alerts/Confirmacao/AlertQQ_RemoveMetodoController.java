...
public class AlertQQ_RemoveMetodoController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if(LanguagesRepository.getPort())
        {
            ...
            info4.setText("ID "+tools.metodo_id.getText()+" - "+tools.txtMetodoPgmt.getText());
