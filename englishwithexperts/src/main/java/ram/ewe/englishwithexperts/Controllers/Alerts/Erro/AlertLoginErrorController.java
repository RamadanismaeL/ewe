...
public class AlertLoginErrorController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        if(LanguagesRepository.getPort())
        {
            ...
            info1.setText("Nome de usuário ou senha inválidos.");
            info2.setText("Tente novamente!");
        }
        else
        {
            title.setText("Error Message");
            info1.setText("Invalid username or password.");
            info2.setText("Please try again!");
        }
